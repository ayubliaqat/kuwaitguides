...
export default function HomeHero() {
  return (
    ...
    >
      {/* Subtle white on left + subtle blue on right */}
      <div className="absolute inset-0 bg-gradient-to-r from-white/40 via-transparent to-[#0071E3]/15 pointer-events-none" />

      <div className="relative max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        <div className="max-w-3xl px-4 sm:px-6 pt-16 sm:pt-12 md:pt-16 pb-8 sm:pb-8 md:pb-12 flex flex-col items-start text-left">
          <h1 className="text-3xl sm:text-5xl md:text-6xl font-bold text-[#333333] tracking-tight leading-[1.1] max-w-2xl">
  Your Complete Guide <br />
  <span className="text-[#0071E3]">to Kuwait</span>
</h1>

          <p className="text-black mt-4 sm:mt-5 max-w-md sm:max-w-lg text-sm sm:text-base md:text-lg leading-relaxed font-normal">
