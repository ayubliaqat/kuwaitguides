export default function WhatYouWillLearn() {
  const guides = [
    ...
    },
    {
      ...
      icon: (
        <svg className="w-5 h-5 text-white group-hover:text-blue-600 transition-colors" fill="none" viewBox="0 0 24 24" stroke="currentColor" strokeWidth="2">
          <path strokeLinecap="round" strokeLinejoin="round" d="M3.055 11H5a2 2 0 012 2v1a2 2 0 002 2 2 2 0 012 2v2.945M8 3.935V5.5A2.5 2.5 0 0010.5 8h.5a2.5 2.5 0 012 2 2 2 0 104 0 2 2 0 012-2h1.064M15 20.488V18a2 2 0 012-2h3.064M21 12a9 9 0 11-18 0 9 9 0 0118 0z" />
        </svg>
      ),
    },
  ];
  ...
  return (
    <section className="py-16 sm:py-20 bg-white border-y border-blue-100">
      <div className="max-w-6xl mx-auto px-6">
        {/* Section Introduction */}
        <div className="max-w-3xl mx-auto text-center">
          <div className="inline-flex items-center gap-2 px-3.5 py-1.5 rounded-full bg-blue-50 border border-blue-200 text-blue-600 text-xs font-semibold uppercase tracking-wider shadow-sm">
            <span className="w-2 h-2 rounded-full bg-blue-600 animate-pulse" />
            What You Can Explore
          </div>

          <h2 className="mt-4 text-3xl sm:text-4xl font-bold tracking-tight text-zinc-900">
            <span className="text-blue-600">Your complete guide</span> to discovering Kuwait
          </h2>
        ...
        <div className="mt-12 grid grid-cols-1 md:grid-cols-6 gap-5">
          {guides.map((guide, index) => (
            <article
              key={index}
              className={`
                group relative rounded-2xl border border-blue-400/60
                bg-blue-600 p-6
            ...
            >
              ...
              <div className="flex items-center gap-3.5">
                <div className="flex-shrink-0 w-10 h-10 rounded-xl bg-blue-500/40 border border-blue-300/40 flex items-center justify-center transition-all duration-300 group-hover:bg-white group-hover:scale-110 shadow-sm">
                  {guide.icon}
                </div>
              ...
              {/* Description */}
              <p className="mt-3 text-blue-100 text-xs sm:text-sm leading-relaxed font-normal">
                {guide.description}
              </p>
            </article>
          ))}
