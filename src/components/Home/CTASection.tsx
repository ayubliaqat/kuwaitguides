  ...
  return (
    <section className="py-16 lg:py-20 bg-white dark:bg-zinc-950">
      <div className="max-w-4xl mx-auto px-6">
        <div className="rounded-[20px] bg-blue-600 dark:bg-blue-600 px-8 py-14 sm:px-14 sm:py-16 text-center border-2 border-blue-400 dark:border-blue-500 shadow-[0_15px_35px_rgba(37,99,235,0.25)] dark:shadow-[0_15px_35px_rgba(0,0,0,0.5)]">
